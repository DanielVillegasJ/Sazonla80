...
if (isset($_SESSION['documento_usuario'])) {
    ...
    $sqlp = "SELECT * FROM pedido WHERE estado = 'Preparado' AND direccion LIKE '%CALLE%' 
    OR estado = 'Preparado' AND direccion LIKE '%CLL%' OR estado = 'Preparado' AND direccion LIKE '%Cll%' 
    OR estado = 'Preparado' AND direccion LIKE '%Calle%' OR estado = 'Preparado' AND direccion LIKE '%calle%' 
    OR estado = 'Preparado' AND direccion LIKE '%cll' OR estado = 'Preparado' AND direccion LIKE '%CARRERA%' 
    OR estado = 'Preparado' AND direccion LIKE '%CRA%' OR estado = 'Preparado' AND direccion LIKE '%Carrera%' 
    OR estado = 'Preparado' AND direccion LIKE '%Cra%' OR estado = 'Preparado' AND direccion LIKE '%carrera%' 
    OR estado = 'Preparado' AND direccion LIKE '%cra%'";
    ...
    <div class="topbar">
            ...
            <div id="mySidebar" class="sidebar">
                <div class="sidebar-content">
                    ...
                    <ul>
                        ...
                        <li><a href="modules/pedir.php">Pedir</a></li>
        ...
        <div class="container">
            ...
            <div id="pedidos-container">
                <?php while ($row = mysqli_fetch_array($queryp)): ?>
