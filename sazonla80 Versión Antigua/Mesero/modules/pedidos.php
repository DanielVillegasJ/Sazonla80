...
if (isset($_SESSION['documento_usuario'])) {
    ...
    $sqlp = "SELECT * FROM pedido WHERE estado = 'Preparado' AND direccion LIKE '%mesa%' OR estado = 'Preparado' 
    AND direccion LIKE '%Mesa%' OR estado = 'Preparado' AND  direccion LIKE '%MESA%'";
